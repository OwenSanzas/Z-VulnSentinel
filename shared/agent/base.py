...
from shared.agent.llm_client import LLMClient, LLMResponse, get_context_window
from shared.agent.result import AgentResult
...
class BaseAgent(ABC):
    ...
    - :meth:`create_context`       — use a custom AgentContext subclass
    """
    ...
    def create_context(self, **kwargs: Any) -> AgentContext:
        """Override to use a custom AgentContext subclass."""
