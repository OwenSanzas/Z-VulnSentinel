"""CLI entry point: python -m vulnsentinel.crawler.go"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Go module crawler")
    ...
    if args.check or args.fix:
        ...
        run_health_check("Go", repos_json, report_md)
        return

    from vulnsentinel.crawler.go import crawl_top, save

    print(f"Crawling top {args.top} Go repositories from GitHub...")
