"""CLI entry point: python -m vulnsentinel.crawler.python"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Python package crawler")
    parser.add_argument("--top", type=int, default=100, help="Number of top packages to crawl")
    ...
    if args.check or args.fix:
        ...
        run_health_check("Python", repos_json, report_md)
        return

    from vulnsentinel.crawler.python import crawl_top, save

    print(f"Crawling top {args.top} Python packages from PyPI...")
