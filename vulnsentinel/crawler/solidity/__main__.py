"""CLI entry point: python -m vulnsentinel.crawler.solidity"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Solidity contract crawler")
    parser.add_argument("--top", type=int, default=100, help="Number of top repos to crawl")
    ...
    if args.check or args.fix:
        ...
        run_health_check("Solidity", repos_json, report_md)
        return

    from vulnsentinel.crawler.solidity import crawl_top, save

    print(f"Crawling top {args.top} Solidity repositories from GitHub...")
